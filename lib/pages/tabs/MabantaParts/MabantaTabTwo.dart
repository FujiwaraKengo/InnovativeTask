...
import 'package:innovativetest/pages/tabs/MabantaParts/Mabanta.dart';

class RoutingPageMabanta extends StatelessWidget {
  final Mabanta details ;

  const RoutingPageMabanta(this.details,  {super.key});
